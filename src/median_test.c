...
#define OPTSTRING "aAbBc:C:dFghHiIk:KlLmM:nNoOPqQ:RsStT:wW:y:z"
#define USAGE_STRING     "[-a] [-A] [-b] [-B] [-c [c1[,c2[,c3[...]]]]] [-C sequences] [-d] [-F] [-g] [-h] [-H] [-i] [-I] [-k col] [-l] [-L] [-m] [-M [m3,n]] [-n] [-N] [-o] [-O] [-P] [-q] [-Q timeout] [-R] [-s] [-S] [-t] [-T sequences] [-w] [-W [f,c]] [-y [n]] [-z] -- [[start incr]] [size [count]]\n\
...
#if 0
        return big_struct_intcmp(*pa, *pb); /* compare as integers (fast) */
#else
        return big_struct_strcmp(*pa, *pb); /* compare as strings (slow) */
#endif
    }
    return 0;
}
...
/* Modified Bentley&McIlroy qsort:
      ...
      improved swapping, don't repeat initialization
