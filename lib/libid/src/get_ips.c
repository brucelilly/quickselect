...
* $Id: ~|^` @(#)    get_ips.c copyright 2015 - 2016 Bruce Lilly.   \ get_ips.c $
...
****************************** (end of license) ******************************/
/* $Id: ~|^` @(#)   This is get_ips.c version 1.3 dated 2016-04-04T17:38:12Z. \ $ */
...
#define MODULE_DATE "2016-04-04T17:38:12Z"
#define COPYRIGHT_HOLDER "Bruce Lilly"
#define COPYRIGHT_DATE "2015 - 2016"

/* feature test macros must appear before any header file inclusion */
#define GET_IPS_C_XOPEN_SOURCE 500
#if ! defined(_XOPEN_SOURCE) || (GET_IPS_C_XOPEN_SOURCE > _XOPEN_SOURCE)
# ifdef _XOPEN_SOURCE
#  undef _XOPEN_SOURCE
# endif
# define _XOPEN_SOURCE GET_IPS_C_XOPEN_SOURCE
#endif
