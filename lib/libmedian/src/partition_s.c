...
/* Description: C source code for partition_s */
/******************************************************************************
...
* $Id: ~|^` @(#)    partition_s.c copyright 2017 Bruce Lilly.   \ partition_s.c $
...
****************************** (end of license) ******************************/
/* $Id: ~|^` @(#)   This is partition_s.c version 1.1 dated 2019-03-06T20:59:17Z. \ partition_s.c $ */
/* You may send bug reports to bruce.lilly@gmail.com with subject "quickselect" */
/*****************************************************************************/
/* maintenance note: master file /data/projects/automation/940/lib/libmedian/src/s.partition_s.c */

/********************** Long description and rationale: ***********************
 This file contains source to implement the public internal partition_s.
...
#include "partition_src.h" /* contains the actual source code */
