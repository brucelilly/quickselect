...
* $Id: ~|^` @(#)    select_min_src.h copyright 2019 Bruce Lilly.   \ select_min_src.h $
...
****************************** (end of license) ******************************/
/* $Id: ~|^` @(#)   This is select_min_src.h version 1.1 dated 2019-03-15T20:53:43Z. \ select_min_src.h $ */
/* You may send bug reports to bruce.lilly@gmail.com with subject "quickselect" */
/*****************************************************************************/
/* maintenance note: master file /data/projects/automation/940/lib/libmedian/include/s.select_min_src.h */
...
#define ID_STRING_PREFIX "$Id: select_min_src.h ~|^` @(#)"
#define SOURCE_MODULE "select_min_src.h"
