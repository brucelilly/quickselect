    ...
    unsigned int options)
{
    ...
    COMPARE_EXCHANGE(pa,pe,options,size,swapf,alignsize,size_ratio);
    /* parallel group */
    COMPARE_EXCHANGE(pa,pc,options,size,swapf,alignsize,size_ratio);
    COMPARE_EXCHANGE(pb,pd,options,size,swapf,alignsize,size_ratio);
    /* parallel group */
    COMPARE_EXCHANGE(pa,pb,options,size,swapf,alignsize,size_ratio);
    COMPARE_EXCHANGE(pc,pe,options,size,swapf,alignsize,size_ratio);
    /* parallel group */
    COMPARE_EXCHANGE(pc,pd,options,size,swapf,alignsize,size_ratio);
    COMPARE_EXCHANGE(pb,pe,options,size,swapf,alignsize,size_ratio);
    /* parallel group */
    COMPARE_EXCHANGE(pb,pc,options,size,swapf,alignsize,size_ratio);
    COMPARE_EXCHANGE(pd,pe,options,size,swapf,alignsize,size_ratio);
}
