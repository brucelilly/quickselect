...
/* $Id: ~|^` @(#)   This is select_max.c version 1.2 dated 2019-03-15T14:05:59Z. \ select_max.c $ */
/* maintenance note: master file /data/projects/automation/940/lib/libmedian_test/src/s.select_max.c */
