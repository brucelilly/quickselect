...
* $Id: ~|^` @(#)    to_double.c copyright 2010 - 2016 Bruce Lilly.   \ to_double.c $
...
****************************** (end of license) ******************************/
/* $Id: ~|^` @(#)   This is to_double.c version 3.1 2016-05-31T16:37:39Z. \ $ */
/* You may send bug reports to bruce.lilly@gmail.com with subject "timespec" */
/*****************************************************************************/
/* maintenance note: master file  /src/radioclk/radioclk-1.0/lib/libtimespec/src/s.to_double.c */
...
#define SOURCE_MODULE "to_double.c"
...
/* convert timespec to double seconds */
double timespec_to_double(const struct timespec *pts)
{
    double ret;
