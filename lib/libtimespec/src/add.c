...
* $Id: ~|^` @(#)    add.c copyright 2010 - 2016 Bruce Lilly.   \ add.c $
...
****************************** (end of license) ******************************/
/* $Id: ~|^` @(#)   This is add.c version 3.1 2016-05-31T16:37:39Z. \ $ */
/* You may send bug reports to bruce.lilly@gmail.com with subject "timespec" */
/*****************************************************************************/
/* maintenance note: master file  /src/radioclk/radioclk-1.0/lib/libtimespec/src/s.add.c */
...
/* add t2 to t1 placing normalized result in t3 */
void timespec_add(const struct timespec *t1, const struct timespec *t2, struct timespec *t3)
{
