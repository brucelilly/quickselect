...
* $Id: ~|^` @(#)    double_to.c copyright 2010 - 2016 Bruce Lilly.   \ double_to.c $
...
****************************** (end of license) ******************************/
/* $Id: ~|^` @(#)   This is double_to.c version 3.1 2016-05-31T16:37:39Z. \ $ */
/* You may send bug reports to bruce.lilly@gmail.com with subject "timespec" */
/*****************************************************************************/
/* maintenance note: master file  /src/radioclk/radioclk-1.0/lib/libtimespec/src/s.double_to.c */
...
#define SOURCE_MODULE "double_to.c"
...
/* convert double seconds to timespec */
void double_to_timespec(double d, struct timespec *pts)
{
    long l;
